...
vim.api.nvim_create_user_command("Wca", M.copy_file_to_clipboard, { desc = "Copy file content to clipboard" })
vim.api.nvim_create_user_command("Wra", M.replace_file_with_clipboard, { desc = "Replace file content with clipboard" })
